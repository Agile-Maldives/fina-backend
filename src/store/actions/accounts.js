...
export const initDeleteAccount = (accountId) => {
    return dispatch => {
        axios.delete('http://api.msresortsrentals.com/api/accounts/' + accountId)
            .then(response => {
...
export const initAccounts = () => {
    return dispatch => {
        axios.get('http://api.msresortsrentals.com/api/accounts',)
            .then(response => {
...
export const createAccount = (account, token) => {
    return dispatch => {
        ...
        let url = 'http://api.msresortsrentals.com/api/accounts/store';
...
export const editAccount = (account, accountId, token) => {
    return dispatch => {
        ...
        let url = 'http://api.msresortsrentals.com/api/accounts/update/' + accountId;
