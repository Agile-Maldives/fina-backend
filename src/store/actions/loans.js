...
export const getLoansForAccountId = (accountId) => {
    return dispatch => {
        axios.get('http://api.msresortsrentals.com/api/loans-by-accountid/' + accountId)
            .then(response => {
...
export const createLoan = (loan, accountId, token) => {
    return dispatch => {
        ...
        let url = 'http://api.msresortsrentals.com/api/loans/store';
...
export const initDeleteLoan = (loanId, accountId) => {
    return dispatch => {
        axios.delete('http://api.msresortsrentals.com/api/loans/' + loanId)
            .then(response => {
...
export const editLoan = (loan, accountId, loanId, token) => {
    ...
    return dispatch => {
        ...
        let url = 'http://api.msresortsrentals.com/api/loans/update/' + loanId;
