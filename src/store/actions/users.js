...
export const initDeleteUser = (userId) => {
    return dispatch => {
        axios.delete('http://api.msresortsrentals.com/api/users/' + userId)
            .then(response => {
...
export const initUsers = () => {
    return dispatch => {
        axios.get('http://api.msresortsrentals.com/api/users')
            .then(response => {
...
export const createUser = (user, token) => {
    ...
    return dispatch => {
        ...
        let url = 'http://api.msresortsrentals.com/api/users/store';
...
export const editUser = (user, userId, token) => {
    return dispatch => {
        ...
        let url = 'http://api.msresortsrentals.com/api/users/update/' + userId;
