...
class AccountsAccountDetails extends Component {
    ...
    render() {
        ...
        let codeLink = ""
        if(currAccount){
            codeLink =<a target="_blank" href={"http://api.msresortsrentals.com/cust/"+currAccount['code']}>{currAccount['code']}</a>
        }
        return (
            <div>
                {authRedirect}
                        ...
                        >
                            ...
                            >
                                <Descriptions.Item label="ID Card">
                                    <a href={"http://api.msresortsrentals.com/api/" + currAccount['id_card_attachment']}>
